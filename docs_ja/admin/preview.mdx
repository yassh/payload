...
label: プレビュー
order: 30
desc: Enable links to your front-end to preview published or draft content. [翻訳済み]
keywords: admin, components, preview, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
Preview is a feature that allows you to generate a direct link to your front-end application. When enabled, a "preview" button will appear on the Edit View within the [Admin Panel](./overview) with an href pointing to the URL you provide. This will provide your editors with a quick way of navigating to the front-end application where that Document's data is represented. Otherwise, they'd have to determine that URL themselves which is not always straightforward especially in complex apps. [翻訳済み]
...
#### Step 1: Format the Preview URL [翻訳済み]
...
#### Step 2: Create the Preview Route [翻訳済み]

Then, create an API route that verifies the preview secret, authenticates the user, and enters draft mode: [翻訳済み]
...
#### Step 3: Query Draft Content [翻訳済み]

Finally, in your front-end application, you can detect draft mode and adjust your queries to include drafts: [翻訳済み]
...
<Banner type="success">
  **Note:** For fully working example of this, check of the official [Draft
  Preview
  Example](__PROTECTED_BLOCK_22__)
  in the [Examples
  Directory](__PROTECTED_BLOCK_23__).
</Banner>
