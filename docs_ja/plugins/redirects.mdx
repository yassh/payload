---
title: Redirects Plugin [翻訳済み]
label: リダイレクト
order: 40
desc: Automatically create redirects for your Payload application
keywords: plugins, redirects, redirect, plugin, payload, cms, seo, indexing, search, search engine [翻訳済み]
---
...
<Banner type="info">
  ...
  here](__PROTECTED_BLOCK_23__).
  If you need help, check out our [Community
  Help](__PROTECTED_BLOCK_24__). If you think you've found a bug,
  please [open a new
  issue](__PROTECTED_BLOCK_25__)
...
Note that the fields in overrides take a function that receives the default fields and returns an array of fields. This allows you to add fields to the collection. [翻訳済み]
