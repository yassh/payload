---
title: Stripe Plugin [翻訳済み]
label: Stripe
order: 40
desc: Easily accept payments with Stripe [翻訳済み]
keywords: plugins, stripe, payments, ecommerce [翻訳済み]
---
...
<Banner type="info">
  ...
  here](__PROTECTED_BLOCK_63__).
  If you need help, check out our [Community
  Help](__PROTECTED_BLOCK_64__). If you think you've found a bug,
  please [open a new
  issue](__PROTECTED_BLOCK_65__)
...
The following custom endpoints are automatically opened for you: [翻訳済み]
...
If you need to proxy the API server-side, use the [stripeProxy](#node) function. [翻訳済み]

<Banner type="info">
  **Note:**

The __PROTECTED_BLOCK_31__ part of these routes may be different based on the settings defined in your Payload
config.
...
If you wish to enable a _two-way_ sync, be sure to setup [__PROTECTED_BLOCK_42__](#webhooks) and pass the
__PROTECTED_BLOCK_43__ through your config.
