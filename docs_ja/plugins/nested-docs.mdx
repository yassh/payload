---
title: Nested Docs Plugin [翻訳済み]
label: ネストされたドキュメント
order: 40
desc: Nested documents in a parent, child, and sibling relationship. [翻訳済み]
keywords: plugins, nested, documents, parent, child, sibling, relationship [翻訳済み]
---
...
<Banner type="info">
  ...
  here](__PROTECTED_BLOCK_66__).
  If you need help, check out our [Community
  Help](__PROTECTED_BLOCK_67__). If you think you've found a bug,
  please [open a new
  issue](__PROTECTED_BLOCK_68__)
...
An array of collections slugs to enable nested docs. [翻訳済み]
...
The function takes two arguments and returns a string: [翻訳済み]
...
If you opt out of automatically being provided a __PROTECTED_BLOCK_49__ or __PROTECTED_BLOCK_50__ field, you need to make
sure that both fields are placed at the top-level of your document. They cannot exist within any
nested data structures like a __PROTECTED_BLOCK_51__, __PROTECTED_BLOCK_52__, or __PROTECTED_BLOCK_53__.
...
If overriding the __PROTECTED_BLOCK_58__ of either __PROTECTED_BLOCK_59__ or __PROTECTED_BLOCK_60__ fields, you must specify the
__PROTECTED_BLOCK_61__ or __PROTECTED_BLOCK_62__ respectively.
