---
title: Search Plugin [翻訳済み]
label: 検索
order: 40
desc: Generates records of your documents that are extremely fast to search on. [翻訳済み]
keywords: plugins, search, search plugin, search engine, search index, search results, search bar, search box, search field, search form, search input [翻訳済み]
---
