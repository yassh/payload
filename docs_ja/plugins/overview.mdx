...
keywords: plugins, config, configuration, extensions, custom, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
...
<Banner type="warning">
  ...
  Directory](__PROTECTED_BLOCK_14__) of the
  [Payload Monorepo](__PROTECTED_BLOCK_15__).
</Banner>

## Community Plugins [翻訳済み]
...
<Banner type="warning">
  ...
  __PROTECTED_BLOCK_6__ topic on [GitHub](__PROTECTED_BLOCK_19__)
