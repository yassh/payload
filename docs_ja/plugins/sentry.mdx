---
title: Sentry Plugin [翻訳済み]
label: Sentry
order: 40
desc: Integrate Sentry error tracking into your Payload application
keywords: plugins, sentry, error, tracking, monitoring, logging, bug, reporting, performance [翻訳済み]
---
...
Sentry is a powerful error tracking and performance monitoring tool that helps developers identify, diagnose, and resolve issues in their applications. [翻訳済み]

<Banner type="success">
  Sentry does smart stuff with error data to make bugs easier to find and fix. -
  [sentry.io](__PROTECTED_BLOCK_17__)
</Banner>

This multi-faceted software offers a range of features that will help you manage errors with greater ease and ultimately ensure your application is running smoothly: [翻訳済み]
...
- **Integrations**: Connects with various tools and services for enhanced workflow and issue management [翻訳済み]

<Banner type="info">
  This plugin is completely open-source and the [source code can be found
  here](__PROTECTED_BLOCK_18__).
  If you need help, check out our [Community
  Help](__PROTECTED_BLOCK_19__). If you think you've found a bug,
  please [open a new
  issue](__PROTECTED_BLOCK_20__)
...
Configure any of these options by passing them to the plugin: [翻訳済み]
