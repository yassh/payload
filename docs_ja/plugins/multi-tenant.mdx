---
title: Multi-Tenant Plugin [翻訳済み]
label: Multi-Tenant [翻訳済み]
order: 40
desc: Scaffolds multi-tenancy for your Payload application
keywords: plugins, multi-tenant, multi-tenancy, plugin, payload, cms, seo, indexing, search, search engine [翻訳済み]
---
...
<Banner type="info">
  ...
  here](__PROTECTED_BLOCK_15__).
  If you need help, check out our [Community
  Help](__PROTECTED_BLOCK_16__). If you think you've found a bug,
  please [open a new
  issue](__PROTECTED_BLOCK_17__) with as much
  detail as possible.
</Banner>
...
You can disable this behavior by setting __PROTECTED_BLOCK_9__ to __PROTECTED_BLOCK_10__ in the plugin options.
...
The plugin accepts an object with the following properties: [翻訳済み]
...
In your frontend you can query and constrain data by tenant with the following: [翻訳済み]
...
The hook returns the following context: [翻訳済み]
