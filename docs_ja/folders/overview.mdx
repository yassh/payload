...
label: 概要
order: 10
desc: Folders allow you to group documents across collections, and are a great way to organize your content. [翻訳済み]
keywords: folders, folder, content organization [翻訳済み]
---
