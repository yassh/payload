---
title: Server-side Live Preview [翻訳済み]
label: Server-side [翻訳済み]
order: 30
desc: Learn how to implement Live Preview in your server-side front-end application. [翻訳済み]
...
<Banner type="info">
  ...
  Components](__PROTECTED_BLOCK_26__). If your
  front-end application is built with a client-side framework like the [Next.js
  Pages Router](__PROTECTED_BLOCK_27__), [React
  Router](__PROTECTED_BLOCK_28__), [Vue 3](__PROTECTED_BLOCK_29__), etc., see
...
## Building your own router refresh component [翻訳済み]
...
#### Updates do not appear as fast as client-side Live Preview [翻訳済み]
