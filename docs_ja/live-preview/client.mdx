---
title: Client-side Live Preview [翻訳済み]
label: Client-side [翻訳済み]
order: 40
desc: Learn how to implement Live Preview in your client-side front-end application. [翻訳済み]
...
<Banner type="info">
  ...
  Router](__PROTECTED_BLOCK_53__), etc., we suggest setting up [server-side
...
By default, all hooks accept the following args: [翻訳済み]
...
And return the following values: [翻訳済み]
...
<Banner type="info">
  ...
  are rendering something like __PROTECTED_BLOCK_22__, your page will
  ...
  needed. For example, __PROTECTED_BLOCK_23__.
</Banner>

<Banner type="info">
  It is important that the __PROTECTED_BLOCK_24__ argument matches exactly with the depth of
...
<Banner type="warning">
  **Reminder:** If you are using [React Server
  Components](__PROTECTED_BLOCK_57__), we strongly
...
This package provides the following functions: [翻訳済み]
...
With these functions, you can build your own hook using your front-end framework of choice: [翻訳済み]
...
#### Relationships and/or uploads are not populating [翻訳済み]
...
#### Relationships and/or uploads disappear after editing a document [翻訳済み]
...
#### Iframe refuses to connect [翻訳済み]
