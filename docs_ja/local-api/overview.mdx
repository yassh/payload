...
keywords: local api, config, configuration, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
...
Here are some common examples of how you can use the Local API: [翻訳済み]
...
_There are more options available on an operation by operation basis outlined below._ [翻訳済み]
...
The following Collection operations are available through the Local API: [翻訳済み]

### Create#collection-create [翻訳済み]
...
### Find by ID#collection-find-by-id [翻訳済み]
...
### Update by ID#collection-update-by-id [翻訳済み]
...
### Update Many#collection-update-many [翻訳済み]
...
### Delete Many#collection-delete-many [翻訳済み]
...
The following Global operations are available through the Local API: [翻訳済み]

### Find#global-find [翻訳済み]
...
Local API calls will automatically infer your [generated types](/docs/typescript/generating-types). [翻訳済み]

Here is an example of usage: [翻訳済み]
