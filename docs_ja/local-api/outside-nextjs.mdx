...
keywords: local api, config, configuration, documentation, Content Management System, cms, headless, javascript, node, react, express [翻訳済み]
---
...
#### Option 2: use an alternative runtime like bun [翻訳済み]
...
You will need to have bun installed on your system for this to work. [翻訳済み]