...
label: HTMLの変換
order: 22
desc: Converting between lexical richtext and HTML [翻訳済み]
keywords: lexical, richtext, html [翻訳済み]
---
## Rich Text to HTML [翻訳済み]

There are two main approaches to convert your Lexical-based rich text to HTML: [翻訳済み]
...
#### Dynamic Population (Advanced) [翻訳済み]
...
2. In [client-side live preview](/docs/live-preview/client), it makes it not "live". [翻訳済み]

Consider using the [on-demand HTML converter above](/docs/rich-text/converting-html#on-demand-recommended) or the [JSX converter](/docs/rich-text/converting-jsx) unless you have a good reason. [翻訳済み]
...
If your rich text includes Lexical blocks, you need to provide a way to convert them to HTML. For example: [翻訳済み]
