...
label: JSXの変換
order: 21
desc: Converting between lexical richtext and JSX [翻訳済み]
keywords: lexical, richtext, jsx [翻訳済み]
---
## Richtext to JSX [翻訳済み]
...
<Banner type="default">
  When fetching data, ensure your __PROTECTED_BLOCK_8__ setting is high enough to fully
...
Example - overriding the upload node converter to use next/image: [翻訳済み]
