...
keywords: lexical, rich text, editor, headless cms [翻訳済み]
label: 概要
order: 10
title: Rich Text Editor [翻訳済み]
---
...
To use the rich text editor, first you need to install it: [翻訳済み]
...
You can also override Lexical settings on a field-by-field basis as follows: [翻訳済み]
...
## Extending the lexical editor with Features [翻訳済み]

Lexical has been designed with extensibility in mind. Whether you're aiming to introduce new functionalities or tweak the existing ones, Lexical makes it seamless for you to bring those changes to life. [翻訳済み]

### Features: The Building Blocks [翻訳済み]

At the heart of Lexical's customization potential are "features". While Lexical ships with a set of default features we believe are essential for most use cases, the true power lies in your ability to redefine, expand, or prune these as needed. [翻訳済み]

If you remove all the default features, you're left with a blank editor. You can then add in only the features you need, or you can build your own custom features from scratch. [翻訳済み]

### Integrating New Features [翻訳済み]
...
## Features overview [翻訳済み]

Here's an overview of all the included features: [翻訳済み]
...
Notice how even the toolbars are features? That's how extensible our lexical editor is - you could theoretically create your own toolbar if you wanted to! [翻訳済み]

## Creating your own, custom Feature [翻訳済み]

You can find more information about creating your own feature in our [building custom feature docs](../rich-text/custom-features). [翻訳済み]
...
### Automatic type generation [翻訳済み]

Lexical does not generate accurate type definitions for your richText fields for you yet - this will be improved in the future. Currently, it only outputs the rough shape of the editor JSON, which you can enhance using type assertions. [翻訳済み]

## Admin customization [翻訳済み]
...
### Customize the placeholder [翻訳済み]
...
## Detecting empty editor state [翻訳済み]
