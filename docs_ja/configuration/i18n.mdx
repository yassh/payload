...
label: I18n [翻訳済み]
order: 40
desc: Manage and customize internationalization support in your CMS editor experience [翻訳済み]
keywords: internationalization, i18n, config, configuration, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
...
<Banner type="success">
  **Note:** If there is a language that Payload does not yet support, we accept
  [code
  contributions](__PROTECTED_BLOCK_25__).
</Banner>
...
To do this, provide the translations wherever applicable, keyed to the language code: [翻訳済み]
...
## Changing Languages [翻訳済み]

Users can change their preferred language in their account settings or by otherwise manipulating their [User Preferences](../admin/preferences). [翻訳済み]
...
In order to use [Custom Translations](#custom-translations) in your project, you need to provide the types for the translations. [翻訳済み]
...
In this example we show how to extend English, but you can do the same for any language you want. [翻訳済み]
...
Import the shared translation types to use in your [Custom Component](../custom-components/overview): [翻訳済み]
