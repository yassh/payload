...
For example, if you've got the following Environment Variable: [翻訳済み]
...
<Banner type="warning">
  **Tip:** Be sure that __PROTECTED_BLOCK_14__ can find your __PROTECTED_BLOCK_15__ file. By default, it will
  look for a file named __PROTECTED_BLOCK_16__ in the root of your project. If you need to
