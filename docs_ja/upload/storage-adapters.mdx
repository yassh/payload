---
title: Storage Adapters [翻訳済み]
label: Storage Adapters [翻訳済み]
order: 20
...
keywords: uploads, images, media, storage, adapters, s3, vercel, google cloud, azure [翻訳済み]
---
...
### Configuration Options#vercel-blob-configuration [翻訳済み]
...
### Installation#s3-installation [翻訳済み]
...
### Configuration Options#s3-configuration [翻訳済み]
...
### Configuration Options#azure-configuration [翻訳済み]
...
## Google Cloud Storage [翻訳済み]

[`@payloadcms/storage-gcs`](https://www.npmjs.com/package/@payloadcms/storage-gcs)

### Installation#gcs-installation [翻訳済み]

```sh
pnpm add @payloadcms/storage-gcs
```

### Usage#gcs-usage [翻訳済み]
...
### Configuration Options#gcs-configuration [翻訳済み]
...
### Configuration Options#uploadthing-configuration [翻訳済み]
...
### Installation#custom-installation [翻訳済み]

`pnpm add @payloadcms/plugin-cloud-storage`

### Usage#custom-usage [翻訳済み]
...
## Collection-specific options [翻訳済み]
...
## Conditionally Enabling/Disabling [翻訳済み]
