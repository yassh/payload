---
title: Getting Started [翻訳済み]
label: Getting Started [翻訳済み]
order: 10
desc: Get started with Payload Cloud, a deployment solution specifically designed for Node + MongoDB applications.
keywords: cloud, hosted, database, storage, email, deployment, serverless, node, mongodb, s3, aws, cloudflare, atlas, resend, payload, cms [翻訳済み]
---
...
## Starting from a Template [翻訳済み]

Templates come preconfigured and provide a one-click solution to quickly deploy a new application. [翻訳済み]
...
Once you are ready, click **Create Project**. This will clone the selected template to a new repository in your GitHub account, and take you to the configuration page to set up your project for deployment. [翻訳済み]

## Importing from an Existing Codebase [翻訳済み]
