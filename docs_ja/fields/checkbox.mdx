---
title: Checkbox Field [翻訳済み]
label: チェックボックス
order: 40
desc: Checkbox field types allow the developer to save a boolean value in the database. Learn how to use Checkbox fields, see examples and options. [翻訳済み]
keywords: checkbox, fields, config, configuration, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
The Checkbox Field saves a boolean in the database. [翻訳済み]

<LightDarkImage
  srcLight="__PROTECTED_BLOCK_26__
  srcDark="__PROTECTED_BLOCK_27__
...
Here is an example of a Checkbox Field in a Collection: [翻訳済み]
