---
title: Join Field [翻訳済み]
label: 結合
order: 140
desc: The Join field provides the ability to work on related documents. Learn how to use Join field, see examples and options. [翻訳済み]
keywords: join, relationship, junction, fields, config, configuration, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
...
The Join field is useful in scenarios including: [翻訳済み]
...
<LightDarkImage
  srcLight="__PROTECTED_BLOCK_84__
  srcDark="__PROTECTED_BLOCK_85__
...
To add a Relationship Field, set the __PROTECTED_BLOCK_9__ to __PROTECTED_BLOCK_10__ in your [Field Config](./overview):

__PROTECTED_BLOCK_0__

In this example, the field is defined to show the related __PROTECTED_BLOCK_11__ when added to a __PROTECTED_BLOCK_12__ collection. The __PROTECTED_BLOCK_13__
...
<Banner type="warning">
  ...
  [DocumentDB](__PROTECTED_BLOCK_86__) and [Azure Cosmos
  DB](__PROTECTED_BLOCK_87__), as we internally
...
### Using the Join field to have full control of your database schema [翻訳済み]
...
#### Specifying additional fields on relationships [翻訳済み]
...
## Join Field Data (polymorphic) [翻訳済み]
...
The following query options are supported: [翻訳済み]
...
<Banner type="warning">
  Currently, __PROTECTED_BLOCK_78__ query support on joined documents for join fields with an
  array of __PROTECTED_BLOCK_79__ is limited and not supported for fields inside arrays
  and blocks.
</Banner>
