---
title: Tabs Field [翻訳済み]
label: タブ
order: 170
desc: The Tabs field is a great way to organize complex editing experiences into specific tab-based areas. [翻訳済み]
keywords: tabs, fields, config, configuration, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
The Tabs Field is presentational-only and only affects the [Admin Panel](../admin/overview) (unless a tab is named). By using it, you can place fields within a nice layout component that separates certain sub-fields by a tabbed interface. [翻訳済み]

<LightDarkImage
  srcLight="__PROTECTED_BLOCK_20__
  srcDark="__PROTECTED_BLOCK_21__
