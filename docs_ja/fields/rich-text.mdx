...
keywords: rich text, fields, config, configuration, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
label: リッチテキスト
order: 140
title: Rich Text Field [翻訳済み]
---
The Rich Text Field lets editors write and format dynamic content in a familiar interface. The content is saved as JSON in the database and can be converted to HTML or any other format needed. [翻訳済み]
...
Instead, you can invest your time and effort into learning the underlying open-source tools that will allow you to apply your learnings elsewhere as well. [翻訳済み]

<LightDarkImage
  alt="Shows a Rich Text field in the Payload Admin Panel"
  caption="Admin Panel screenshot of a Rich Text field"
  srcDark="__PROTECTED_BLOCK_18__
  srcLight="__PROTECTED_BLOCK_19__
/>
...
Further customization can be done with editor-specific options. [翻訳済み]

## Editor-specific Options [翻訳済み]

For a ton more editor-specific options, including how to build custom rich text elements directly into your editor,
take a look at the [rich text editor documentation](../rich-text/overview). [翻訳済み]