---
title: Relationship Field [翻訳済み]
label: リレーション
order: 130
desc: The Relationship field provides the ability to relate documents together. Learn how to use Relationship fields, see examples and options. [翻訳済み]
keywords: relationship, fields, config, configuration, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
...
<LightDarkImage
  srcLight="__PROTECTED_BLOCK_138__
  srcDark="__PROTECTED_BLOCK_139__
...
- To add __PROTECTED_BLOCK_18__ documents to an __PROTECTED_BLOCK_19__ document
- To allow for an __PROTECTED_BLOCK_20__ to feature a __PROTECTED_BLOCK_21__ relationship to either an __PROTECTED_BLOCK_22__ or __PROTECTED_BLOCK_23__ collection
- To assign __PROTECTED_BLOCK_24__ documents to __PROTECTED_BLOCK_25__ documents

To add a Relationship Field, set the __PROTECTED_BLOCK_26__ to __PROTECTED_BLOCK_27__ in your [Field Config](./overview):
...
| Option                 | Description                                                                                                                                                                                                                                                                                             |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **__PROTECTED_BLOCK_28__** \*          | To be used as the property name when stored and retrieved from the database. [More](/docs/fields/overview#field-names)                                                                                                                                                                                  |
| **__PROTECTED_BLOCK_29__** \*    | Provide one or many collection __PROTECTED_BLOCK_30__s to be able to assign relationships to.                                                                                                                                                                                                                           |
| **__PROTECTED_BLOCK_31__**    | A query to filter which options appear in the UI and validate against. [More](#filtering-relationship-options).                                                                                                                                                                                         |
| **__PROTECTED_BLOCK_32__**          | Boolean when, if set to __PROTECTED_BLOCK_33__, allows this field to have many relations instead of only one.                                                                                                                                                                                                           |
| **__PROTECTED_BLOCK_34__**          | A number for the fewest allowed items during validation when a value is present. Used with __PROTECTED_BLOCK_35__.                                                                                                                                                                                                   |
| **__PROTECTED_BLOCK_36__**          | A number for the most allowed items during validation when a value is present. Used with __PROTECTED_BLOCK_37__.                                                                                                                                                                                                     |
| **__PROTECTED_BLOCK_38__**         | Sets a maximum population depth for this field, regardless of the remaining depth when this field is reached. [Max Depth](/docs/queries/depth#max-depth)                                                                                                                                                |
| **__PROTECTED_BLOCK_39__**            | Text used as a field label in the Admin Panel or an object with keys for each language.                                                                                                                                                                                                                 |
| **__PROTECTED_BLOCK_40__**           | Enforce that each entry in the Collection has a unique value for this field.                                                                                                                                                                                                                            |
| **__PROTECTED_BLOCK_41__**         | Provide a custom validation function that will be executed on both the Admin Panel and the backend. [More](/docs/fields/overview#validation)                                                                                                                                                            |
| **__PROTECTED_BLOCK_42__**            | Build an [index](/docs/database/overview) for this field to produce faster queries. Set this field to __PROTECTED_BLOCK_43__ if your users will perform queries on this field's data often.                                                                                                                             |
| **__PROTECTED_BLOCK_44__**        | If this field is top-level and nested in a config supporting [Authentication](/docs/authentication/overview), include its data in the user JWT.                                                                                                                                                         |
| **__PROTECTED_BLOCK_45__**            | Provide Field Hooks to control logic for this field. [More details](../hooks/fields).                                                                                                                                                                                                                   |
| **__PROTECTED_BLOCK_46__**           | Provide Field Access Control to denote what users can see and do with this field's data. [More details](../access-control/fields).                                                                                                                                                                      |
| **__PROTECTED_BLOCK_47__**           | Restrict this field's visibility from all APIs entirely. Will still be saved to the database, but will not appear in any API or the Admin Panel.                                                                                                                                                        |
| **__PROTECTED_BLOCK_48__**     | Provide data to be used for this field's default value. [More](/docs/fields/overview#default-values)                                                                                                                                                                                                    |
| **__PROTECTED_BLOCK_49__**        | Enable localization for this field. Requires [localization to be enabled](/docs/configuration/localization) in the Base config.                                                                                                                                                                         |
| **__PROTECTED_BLOCK_50__**         | Require this field to have a value.                                                                                                                                                                                                                                                                     |
| **__PROTECTED_BLOCK_51__**            | Admin-specific configuration. [More details](#admin-options).                                                                                                                                                                                                                                           |
| **__PROTECTED_BLOCK_52__**           | Extension point for adding custom data (e.g. for plugins)                                                                                                                                                                                                                                               |
| **__PROTECTED_BLOCK_53__** | Override field type generation with providing a JSON schema                                                                                                                                                                                                                                             |
| **__PROTECTED_BLOCK_54__**          | Provide __PROTECTED_BLOCK_55__ to disable field in the database, or provide a string path to [link the field with a relationship](/docs/fields/relationship#linking-virtual-fields-with-relationships). See [Virtual Fields](__PROTECTED_BLOCK_140__) |
| **__PROTECTED_BLOCK_56__**          | Custom graphQL configuration for the field. [More details](/docs/graphql/overview#field-complexity)                                                                                                                                                                                                     |
...
The Relationship Field inherits all of the default admin options from the base [Field Admin Config](./overview#admin-options), plus the following additional options: [翻訳済み]
...
collections. You can prefix the field name with a minus symbol ("-") to sort in descending order. [翻訳済み]
...
allows for different sorting fields for each collection's relationship dropdown. [翻訳済み]
...
## Filtering relationship options [翻訳済み]

Options can be dynamically limited by supplying a [query constraint](/docs/queries/overview), which will be used both for validating input and filtering available relationships in the UI. [翻訳済み]
...
You can learn more about writing queries [here](/docs/queries/overview). [翻訳済み]
...
## Bi-directional relationships [翻訳済み]
...
The shape of the data to save for a document with the field configured this way would be: [翻訳済み]
...
When querying documents in this collection via REST API, you could query as follows: [翻訳済み]

`?where[owner][equals]=6031ac9e1289176380734024`.

### Has One - Polymorphic [翻訳済み]
...
The shape of the data to save for a document with more than one relationship type would be: [翻訳済み]
...
You can also query for documents where a field has a relationship to a specific Collection: [翻訳済み]

`?where[owners.relationTo][equals]=organizations`.

This query would return only documents that have an owner relationship to organizations. [翻訳済み]
...
When querying documents, the format does not change for arrays: [翻訳済み]

`?where[owners][equals]=6031ac9e1289176380734024`.

### Has Many - Polymorphic [翻訳済み]
...
Querying is done in the same way as the earlier Polymorphic example: [翻訳済み]

`?where[owners.value][equals]=6031ac9e1289176380734024`.

### Querying and Filtering Polymorphic Relationships [翻訳済み]
...
The data can be queried by the related document ID: [翻訳済み]

`?where[field.value][equals]=6031ac9e1289176380734024`.

Or by the related document Collection slug: [翻訳済み]
...
Since we are referencing multiple collections, the field you are querying on may not exist and break the query. [翻訳済み]
...
### Linking virtual fields with relationships [翻訳済み]

You can link virtual fields to fields in other collections through a relationship (or upload) field, for example: [翻訳済み]
