---
title: Upload Field [翻訳済み]
label: アップロード
order: 210
desc: Upload fields will allow a file to be uploaded, only from a collection supporting Uploads. Learn how to use Upload fields, see examples and options. [翻訳済み]
keywords: upload, images media, fields, config, configuration, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
The Upload Field allows for the selection of a Document from a Collection supporting [Uploads](../upload/overview), and
formats the selection as a thumbnail in the Admin Panel. [翻訳済み]

Upload fields are useful for a variety of use cases, such as: [翻訳済み]
...
<LightDarkImage
  srcLight="__PROTECTED_BLOCK_58__
  srcDark="__PROTECTED_BLOCK_59__
  alt="Shows an upload field in the Payload Admin Panel"
  caption="Admin Panel screenshot of an Upload field"
/>

To create an Upload Field, set the __PROTECTED_BLOCK_5__ to __PROTECTED_BLOCK_6__ in your [Field Config](./overview):
...
### Example#filter-options-example [翻訳済み]
