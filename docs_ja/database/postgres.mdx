...
keywords: Postgres, documentation, typescript, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
...
It automatically manages changes to your database for you in development mode, and exposes a full suite of migration controls for you to leverage in order to keep other database environments in sync with your schema. DDL transformations are automatically generated. [翻訳済み]
...
<Banner type="info">
  **Note:** If you're using __PROTECTED_BLOCK_15__ your
  __PROTECTED_BLOCK_16__ or __PROTECTED_BLOCK_17__ points to a local
  database (e.g hostname has __PROTECTED_BLOCK_18__ or __PROTECTED_BLOCK_19__) we use the __PROTECTED_BLOCK_20__ module
  for pooling instead of __PROTECTED_BLOCK_21__. This is because __PROTECTED_BLOCK_22__
  doesn't work with local databases, if you want to disable that behavior, you
  can pass __PROTECTED_BLOCK_23__ to the adapter's args and follow
  [Vercel
  guide](__PROTECTED_BLOCK_65__)
...
## Access to Drizzle [翻訳済み]

After Payload is initialized, this adapter will expose the full power of Drizzle to you for use if you need it.

To ensure type-safety, you need to generate Drizzle schema first with: [翻訳済み]

```sh
npx payload generate:db-schema
```

Then, you can access Drizzle as follows: [翻訳済み]
...
## Tables, relations, and enums [翻訳済み]
...
## Prototyping in development mode [翻訳済み]

Drizzle exposes two ways to work locally in development mode. [翻訳済み]
...
You will be warned if any changes that you make will entail data loss while in development mode. Push is enabled by default, but you can opt out if you'd like. [翻訳済み]
...
For more information about migrations, [click here](./migrations#when-to-run-migrations). [翻訳済み]

## Drizzle schema hooks [翻訳済み]

### beforeSchemaInit [翻訳済み]
...
### Note for generated schema: [翻訳済み]
