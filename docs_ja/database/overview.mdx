...
label: 概要
order: 10
keywords: database, mongodb, postgres, documentation, Content Management System, cms, headless, typescript, node, react, nextjs [翻訳済み]
...
There are two main categories of databases to choose from: [翻訳済み]

- [Non-Relational Databases](#non-relational-databases)
- [Relational Databases](#relational-databases) [翻訳済み]

### Non-Relational Databases [翻訳済み]
