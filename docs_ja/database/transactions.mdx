...
label: トランザクション
order: 30
keywords: database, transactions, sql, mongodb, postgres, documentation, Content Management System, cms, headless, typescript, node, react, nextjs [翻訳済み]
...
Transactions in SQLite are disabled by default. You need to pass __PROTECTED_BLOCK_5__ to enable them.
...
## Async Hooks with Transactions [翻訳済み]
...
## Direct Transaction Access [翻訳済み]
...
The following functions can be used for managing transactions: [翻訳済み]
