...
keywords: overview, access control, permissions, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
...
Access Control functions are scoped to the _operation_, meaning you can have different rules for __PROTECTED_BLOCK_2__, __PROTECTED_BLOCK_3__, __PROTECTED_BLOCK_4__, __PROTECTED_BLOCK_5__, etc. Access Control functions are executed _before_ any changes are made and _before_ any operations are completed. This allows you to determine if the user has the necessary permissions before fulfilling the request.

There are many use cases for Access Control, including:

- Allowing anyone __PROTECTED_BLOCK_6__ access to all posts
- Only allowing public access to posts where a __PROTECTED_BLOCK_7__ field is equal to __PROTECTED_BLOCK_8__
- Giving only users with a __PROTECTED_BLOCK_9__ field equal to __PROTECTED_BLOCK_10__ the ability to delete posts
- Allowing anyone to submit contact forms, but only logged in users to __PROTECTED_BLOCK_11__, __PROTECTED_BLOCK_12__ or __PROTECTED_BLOCK_13__ them
...
<Banner type="warning">
  **Important:** In the [Local API](../local-api/overview), all Access Control
  ...
  your application. To opt back in, you can set the __PROTECTED_BLOCK_14__ option to
  __PROTECTED_BLOCK_15__ in your requests.
</Banner>

## The Access Operation [翻訳済み]
...
<Banner type="warning">
  **Important:** When your access control functions are executed via the [Access
  Operation](../authentication/operations#access), the __PROTECTED_BLOCK_17__ and __PROTECTED_BLOCK_18__ arguments
  will be __PROTECTED_BLOCK_19__. This is because Payload is executing your functions
...
## Locale Specific Access Control [翻訳済み]
