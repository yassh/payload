---
title: JWT Strategy [翻訳済み]
label: JWT Strategy [翻訳済み]
order: 40
...
<Banner type="success">
  **Tip:** You can access the logged-in user from within [Access
  ...
  the __PROTECTED_BLOCK_6__ argument. [More details](./token-data).
</Banner>

### Identifying Users Via The Authorization Header [翻訳済み]
