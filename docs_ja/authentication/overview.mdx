---
title: Authentication Overview [翻訳済み]
label: 概要
order: 10
...
keywords: authentication, config, configuration, overview, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
...
To enable Authentication on a Collection, use the __PROTECTED_BLOCK_5__ property in the [Collection Config](../configuration/collections#config-options):

__PROTECTED_BLOCK_0__

![Authentication Admin Panel functionality](__PROTECTED_BLOCK_52__)
...
<Banner type="warning">
  **Note:** By default, Payload provides an auth-enabled __PROTECTED_BLOCK_6__ Collection which
...
<Banner type="info">
  **Tip:** For default auth behavior, set __PROTECTED_BLOCK_8__. This is a good starting
  point for most applications.
</Banner>

<Banner type="warning">
  **Note:** Auth-enabled Collections will be automatically injected with the
  __PROTECTED_BLOCK_9__, __PROTECTED_BLOCK_10__, and __PROTECTED_BLOCK_11__ fields. [More
...
Or, you can pass an object with additional options: [翻訳済み]
...
For testing and demo purposes you may want to skip forcing the user to login in order to access your application. Typically, all users should be required to login, however, you can speed up local development time by enabling auto-login. [翻訳済み]
...
- [API-Keys](./api-keys) [翻訳済み]

Each of these strategies can work together or independently. You can also create your own custom strategies to fit your specific needs. [More details](./custom-strategies). [翻訳済み]

### HTTP-Only Cookies [翻訳済み]
