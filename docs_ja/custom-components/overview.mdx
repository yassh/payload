...
<Banner type="success">
  **Note:** Client Components continue to be fully supported. To use Client
  Components in your app, simply include the __PROTECTED_BLOCK_21__ directive. Payload
  will automatically detect and remove all
  [non-serializable](__PROTECTED_BLOCK_63__)
...
- [Field Components](../fields/overview#custom-components) [翻訳済み]
...
## Defining Custom Components [翻訳済み]
...
<Banner type="success">
  **Note:** All Custom Components can be either Server Components or Client
  Components, depending on the presence of the __PROTECTED_BLOCK_22__ directive at the
  top of the file.
</Banner>

### Component Paths [翻訳済み]
...
### Component Config [翻訳済み]

While Custom Components are usually defined as a string, you can also pass in an object with additional options: [翻訳済み]
...
For details on how to build Custom Components, see [Building Custom Components](#building-custom-components). [翻訳済み]
...
#### Overriding Import Map Location [翻訳済み]
...
## Building Custom Components [翻訳済み]
...
Each Custom Component receives the following props by default: [翻訳済み]
...
Here is how your component might receive this prop: [翻訳済み]
...
<Banner type="warning">
  **Reminder:** Client Components cannot be passed [non-serializable
  props](__PROTECTED_BLOCK_69__). If you
...
Similarly, all [Field Components](../fields/overview#custom-components) automatically receive their respective Field Config through props. [翻訳済み]
...
### Getting the Current Language [翻訳済み]
...
### Getting the Current Locale [翻訳済み]
...
Then to colorize your Custom Component's background, for example, you can use the following CSS: [翻訳済み]
