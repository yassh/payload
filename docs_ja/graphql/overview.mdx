...
keywords: graphql, resolvers, mutations, config, configuration, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
...
**And the following mutations:** [翻訳済み]
...
Globals are also fully supported. For example: [翻訳済み]
...
**And the following mutation:** [翻訳済み]
...
(by default at
[__PROTECTED_BLOCK_53__](__PROTECTED_BLOCK_58__))
