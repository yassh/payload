---
title: Adding your own Queries and Mutations [翻訳済み]
label: Custom Queries and Mutations [翻訳済み]
order: 20
...
keywords: graphql, resolvers, mutations, custom, queries, config, configuration, documentation, Content Management System, cms, headless, javascript, node, react, nextjs [翻訳済み]
---
...
The above properties each receive a function that is defined with the following arguments: [翻訳済み]
...
Your function will receive four arguments you can make use of: [翻訳済み]
...
The previous object. Not very often used and usually discarded. [翻訳済み]

**`args`**

The available arguments from your query or mutation will be available to you here, these must be configured via the custom operation first. [翻訳済み]
...
<Banner type="warning">
  For queries, mutations and handlers make sure you use the __PROTECTED_BLOCK_26__ and
  __PROTECTED_BLOCK_27__ instances provided via arguments.
</Banner>
